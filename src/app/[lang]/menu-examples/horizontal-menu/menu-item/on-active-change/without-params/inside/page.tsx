      ...
      <div className={classnames('flex items-center plb-2.5 pli-6 is-full', styles.customStyles)}>
        <HorizontalNav>
          <Menu menuItemStyles={{ button: { paddingBlock: '12px' } }}>
            <MenuItem href='/en/menu-examples/horizontal-menu/menu-item/on-active-change/without-params'>
              Analytics Dashboard
            </MenuItem>
            <MenuItem
              href='/en/menu-examples/horizontal-menu/menu-item/on-active-change/without-params/inside'
              onActiveChange={() => {
